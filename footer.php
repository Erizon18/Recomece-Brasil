    ...
    <footer>
        <div class="container">
            ...
            <div id="footer-middle">
                <div class="redes">
                    <div class="redes-img">
                        <a href="https://goo.gl/maps/k4CYU2XknW4o6ELU8">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="#ffffff" class="bi bi-geo-alt" viewBox="0 0 16 16">
                ...
                <div class="redes">
                    <div class="redes-img">
                        <a href="tel:8530210303">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="#ffffff" class="bi bi-telephone" viewBox="0 0 16 16">
                ...
                <div class="redes">
                    <div class="redes-img">
                        <a href="mailto:recomecebrasiladm@gmail.com">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" fill="#ffffff" class="bi bi-envelope" viewBox="0 0 16 16">
